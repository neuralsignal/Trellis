...
| --------------------------------------------- | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--platform claude\|codex\|devin\|grok\|opencode\|pi\|zcode\|all` | all               | Default `all`. `devin` is Cognition's Devin CLI (`sessions.db`). |
...
- **`--platform devin` is Cognition's Devin CLI** (`~/.local/share/devin/cli/sessions.db`) — a conversation-log source, unrelated to the platforms Trellis configures.
