...
_FIRST_REPLY_NOTICE_TAIL = """Acknowledge in the language of the user's request; failing that the project's; failing that exactly `Trellis SessionStart ✓`. It sets no language for the rest of the reply. Then answer directly.
