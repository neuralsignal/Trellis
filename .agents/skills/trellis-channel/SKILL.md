...
Typical user signals: "brainstorm with another agent", "spawn an implement/check worker", "let agent review", "open an issue board / changelog forum", "look at this thread", "channel is stuck / no output", "progress was truncated", "how do I write that channel command".
...
| User intent | Read |
|---|---|
| "brainstorm with another agent", "discuss this with codex/claude" | `references/workflows.md` |
| "spawn a worker", "have an agent review this" | `references/workflows.md`, then `references/workers.md` |
| "make a forum", "open an issue board / changelog" | `references/forum.md` |
| "inspect a thread", "look at this thread / linked context" | `references/forum.md` |
| "worker stalled", "channel is stuck / no output / progress truncated" | `references/progress-debugging.md` |
| "what flags does X take", "how do I write that channel command" | `references/command-reference.md` |
