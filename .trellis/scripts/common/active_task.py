...
# with a neighbour: a 2026-08-05 audit found most declared names had never
# existed anywhere — they were pattern-guessed from a `<PLATFORM>_SESSION_ID`
...
# through TRELLIS_CONTEXT_ID or its hook/plugin bridge.
